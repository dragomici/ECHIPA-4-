    ...
    <div className="header__bottom">
      <div className="header__container">
        ...
        <nav className="header__nav">
          ...
          <a href="#" className="header__nav-item">Pages <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="chevron-icon"><polyline points="6 9 12 15 18 9"></polyline></svg></a>
